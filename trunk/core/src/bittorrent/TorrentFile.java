...
public class TorrentFile {
     ...
     * @throws IllegalArgumentException If <code>file</code> is <code>null</code> or a directory
     * @throws IOException              If an I/O error occurs whilst analyzing the torrent file
     */
     ...
     * @throws FileNotFoundException If one of the files associated with the torrent could not be
     *                               found
     ...
     *             multiple files
     * @throws IllegalArgumentException If <code>file</code> is null or if <code>file</code> is a
